...
const skyTexure = textureLoader.load(skyImage);
scene.background = skyTexure

// Geometry
const geometry = new THREE.PlaneGeometry(7, 7, 512, 512);
...
gui.add(material.uniforms.uSmallWaveFrequency, "value").min(0).max(30).step(0.01).name("uSmallWaveFrequencyr");
gui.add(material.uniforms.uSmallWaveSpeed, "value").min(0).max(4).step(0.01).name("uSmallWaveSpeed");
